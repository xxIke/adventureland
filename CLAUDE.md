...
Root Claude Code bootstrap for AdventureLand bot — a browser-native bot system for [AdventureLand](https://adventure.land), a code MMORPG where players write JavaScript to control their characters. Systems: scheduler, event bus, world model, configuration, logging, targeting, attack, combat skills, merchant skills, movement, objective (hunter/merchant strategies), party, potion/regen. Game docs: [adventure.land/docs](https://adventure.land/docs)
